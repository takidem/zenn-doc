...
最近こういう要件が業務で出てきたので、実際に自分でやってみます。
クラスメソッド様の[こちらのブログ](https://dev.classmethod.jp/articles/entra-id-gws-sso/#%25E3%2581%25AF%25E3%2581%2598%25E3%2582%2581%25E3%2581%25AB)を一部参考にしています。
...
[Entra ID]>[Entreprise Applications]>[New Application]を押下します。
...
では、設定していきます。エンタープライズアプリケーションのプロビジョニング画面から[Attirbute mapping]>[Provision Microsoft Entra ID Users]を押下します。
